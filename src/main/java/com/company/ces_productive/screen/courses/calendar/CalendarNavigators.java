...
@Component("CES_Courses_CalendarNavigators")
public class CalendarNavigators {
    @Autowired
    private CurrentAuthentication currentAuthentication;

    public CalendarNavigation forMode(CalendarScreenAdjustment screenAdjustment, DatatypeFormatter datatypeFormatter,
            CalendarMode mode)
    {
        switch (mode) {
