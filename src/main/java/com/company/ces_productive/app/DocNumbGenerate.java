...
@Service
public class DocNumbGenerate implements Serializable {
    @Serial
    private static final long serialVersionUID = 1L;
    private static final Logger log = org.slf4j.LoggerFactory.getLogger(DocNumbGenerate.class);
    private AtomicInteger nextNumber;
    private static final String SERIAL_FILE = "docnumber.ser";

    public DocNumbGenerate() {
        try {
    ...
    public String getNextNumber(String docCode, String branchCode) {
        int ordinalNumber = nextNumber.getAndIncrement();
        String formattedNumber = String.format("%s-%s-%08d", docCode, branchCode, ordinalNumber);
        try {
