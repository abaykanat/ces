...
@Service
public class StudNumbGenerate implements Serializable {
    @Serial
    private static final long serialVersionUID = 1L;
    private static final Logger log = org.slf4j.LoggerFactory.getLogger(StudNumbGenerate.class);
    private AtomicInteger nextNumber;
    private static final String SERIAL_FILE = "studnumber.ser";

    public StudNumbGenerate() {
        try {
    ...
    public String getNextNumber(String branchCode) {
        int ordinalNumber = nextNumber.getAndIncrement();
        String formattedNumber = String.format("%s-%s-%06d", "STD", branchCode, ordinalNumber);
        try {
